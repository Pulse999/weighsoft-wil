...
angular
        ...
        .controller('ProductsCtrl', function($scope, $rootScope, $navigation, $Functions, $http, $state, $modal, Restangular, $q, DTOptionsBuilder){
            $rootScope.Start();
            var vm = this;
            ...
            var ObjectProperties = {
                ...
                vat: {
                    type: "string", title: "Vat Percentage", description: ""
                },
                code: {type: "string", title: "Product Code", description: ""},
                purchase_price: {type: "string", title: "Purchase Price", description: ""},
                sale_price: {type: "string", title: "Sale Price", description: ""},
                name: {type: "string", title: "Product Name", description: ""},
                grades_enabled: {
                    type: "string", title: "Enable Grades", description: ""
                },
                grades: {
                    type: "string", title: "Product Grades", description: ""
                },
            };
            var EmptyObject = {company_id: "", code: "", name: "", actiontype: "New", grade_enabled: "", grades: ""};
            ...
            vm.load = function(){
                    ...
                    switch(type){
                        ...
                        case "site":
                            ...
                            $Functions.Site().then(function(siteList){
                                ...
                                $rootScope.Loaded("Single Site on ProductsCtrl");
                            }, function(response){
                ...
                vm.form = [
                    ...
                    {
                        "key": "grades_enabled",
                        "type": "radiobuttons", // Replace this with the correct type for a slider switch
                        "style": {
                            "selected": "btn-black",
