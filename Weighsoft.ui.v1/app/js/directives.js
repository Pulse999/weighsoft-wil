            ...
            return {
                ...
                link: function(scope, el, attrs){
                    ...
                    function goTo(plus_one){
                        ...
                        $status_list.filter('.active').removeClass('active');
                        $status_list.eq(index).addClass('active').fadeTo(0, 0).fadeTo(320, 1);
                    }

                    $nav.on('click', function(ev){
                        ev.preventDefault();
                        goTo($(this).hasClass('xe-prev') ? -1 : 1);
                    });
                }
            };
        }).
